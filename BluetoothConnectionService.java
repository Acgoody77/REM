package com.heath.rem_bluetooth;
...
/**
 * Created by A.GOODMAN on 7/24/2017.
 */

public class BluetoothConnectionService {
    private static final String TAG = "BluetoothConnectionServ";

    private static final String appName = "Heath REM";

    //private static final UUID MY_UUID_INSECURE =
      //      UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    private static final UUID MY_UUID_INSECURE = UUID.fromString(UUID.randomUUID().toString());
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                Log.d(TAG, "run: ConnectThred connected.");
            } catch (IOException e) {
                try {
                    mmSocket.close();
    ...
    private class ConnectedThread extends Thread{
        ...
        public void run(){
            byte[] buffer = new byte[1024]; //store input stream
            ...
            while(true){
                try {
                    ...
                    //sending data over to message
                    Intent incomingMessageIntent = new Intent("incomingMessage");
                    incomingMessageIntent.putExtra("theMessage" , incomingMessage);
                    LocalBroadcastManager.getInstance(mContext).sendBroadcast(incomingMessageIntent);

                } catch (IOException e) {
                    Log.e(TAG, "run: error reading input string" + e.getMessage() );
                    break;
                }
